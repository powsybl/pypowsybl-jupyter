...
- fixed_nad_positions: positions dataframe to layout the voltage levels in the NAD. The fixed positions dataframe is fully described in [Pypowsybl Network area diagram documentation](https://powsybl.readthedocs.io/projects/pypowsybl/en/stable/user_guide/network_visualization.html#network-area-diagram). 
